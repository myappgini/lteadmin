                    ...
                    <header class="main-header">
                      ...
                      <a href="index.php" class="logo">
                        ...
                        <span class="logo-mini"><b><i class="glyphicon glyphicon-home"></i></b>&nbsp;ALE</span>
                        <!-- logo for regular state and mobile devices -->
                        <span class="logo-lg"><b><i class="glyphicon glyphicon-home"></i>&nbsp;ALE</b></span>
                      </a>
                      ...
                      <nav class="navbar navbar-static-top" role="navigation">
                        ...
                        <p class="navbar-text hidden-xs" style="color: white;">Alejandro Landini powered</p>
